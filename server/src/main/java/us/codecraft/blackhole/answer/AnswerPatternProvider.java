...
public class AnswerPatternProvider implements AnswerProvider {
    ...
    /**
     * @param domainPatterns the domainPatterns to set
     */
    public void setDomainPatterns(Map<Pattern, String> domainPatterns) {
        this.domainPatternsContainer.setDomainPatterns(domainPatterns);
    }

    public void setDomainTexts(Map<String, String> domainTexts) {
        this.domainPatternsContainer.setDomainTexts(domainTexts);
    }
}
